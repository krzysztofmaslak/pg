    ...
    def get_all(self, lang):
        if lang=='en':
            return {
                ...
                'offer_form_multiple_variations_required': 'Has any variations ?',
                'offer_form_quantity': 'Quantity',
                'offer_form_net': 'Net',
                'offer_form_tax': 'Tax',
                'offer_form_shipping': 'Shipping',
                'offer_form_shipping_additional':'Shipping additional',
                'offer_form_quantity_required': 'Quantity is required',
                ...
                'offer_form_currency_required':'Currency is required',
                'offer_form_add_product':'Add product',
                'offer_form_save_offer':'Save offer',
                'offer_form_please_select':'--Please select--',
                'offer_form_net_required': 'Net is required',
                'offer_form_shipping_required':'Shipping is required',
