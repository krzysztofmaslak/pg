...
class RegisterTest(Base):
    ...
    def test_register(self):
        r = self.client.post('/rest/register/', data=json.dumps({'username':'test@justsale.it', 'password':'123'}), content_type='application/json', headers=[('Content-Type', 'application/json')], environ_base=self.environ_base)
